...
pub fn close_button() win32.RECT {
    return win32.RECT{
...
pub fn volume_header() win32.RECT {
...
pub fn speaker_icon() win32.RECT {
...
pub fn set_default_button() win32.RECT {
...
pub fn reset_default_button() win32.RECT {
    const button_width = @divTrunc(Size.widget_width - Size.padding * 2 - 12, 2);
...
pub fn contains_point(rect: win32.RECT, x: i32, y: i32) bool {
...
pub fn center(rect: win32.RECT) struct { x: f32, y: f32 } {
    std.debug.assert(rect.right >= rect.left);
    std.debug.assert(rect.bottom >= rect.top);
